...
package com.gulag.PeekAtBayntun.env;
...
public class BorderedText {
  ...
  public void drawText(final Canvas canvas, final float posX, final float posY, final String text) {
    ...
    canvas.rotate(90);
    canvas.drawText(text, 0, 0, exteriorPaint);//posX, posY, exteriorPaint);
    canvas.drawText(text, 0, 0, interiorPaint);//posX, posY, interiorPaint);
    canvas.rotate(-90);
    canvas.translate(-posX, -posY);*/
