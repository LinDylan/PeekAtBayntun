...
package com.gulag.PeekAtBayntun.tracking;
...
import com.gulag.PeekAtBayntun.env.Size;
...
public class  ObjectTracker {
  ...
  private void drawKeypointsDebug(final Canvas canvas) {
    ...
    for (final PointChange keypoint : lastKeypoints.pointDeltas) {
      if (keypoint.wasFound) {
        ...
        canvas.drawRect(screenPoints[2] - keypointSize, //2
                screenPoints[3] - keypointSize, //3
                screenPoints[2] + keypointSize, //2
                screenPoints[3] + keypointSize, p); //3
  ...
  public class TrackedObject {
    ...
    private synchronized void updateTrackedPosition() {
      ...
      lastTrackedPosition = new RectF(delta[2], delta[3], delta[1], delta[0]);
